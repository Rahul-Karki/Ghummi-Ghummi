...
const styles = StyleSheet.create({
  ...
  heroTitle: { fontFamily: 'Inter', fontSize: 28, letterSpacing: -0.8, lineHeight: 34 },
  ...
  sectionTitle: { fontFamily: 'Inter', fontSize: 20, letterSpacing: -0.5 },
  ...
  exploreCardTitle: { fontFamily: 'Inter', fontSize: 22, letterSpacing: -0.5 },
  ...
  featuredName: { fontFamily: 'Inter', fontSize: 14, lineHeight: 18 },
